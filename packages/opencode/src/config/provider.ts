  ...
  options: Schema.optional(
    Schema.StructWithRest(
      Schema.Struct({
        ...
        body: Schema.optional(Schema.Record(Schema.String, Schema.Any)).annotate({
          description: "Custom fields to merge into every outgoing HTTP request body for this provider",
        }),
      }),
      [Schema.Record(Schema.String, Schema.Any)],
    ),
